...
test("test createVideo with test_transition2.json", async () => {
  ...
  assert.deepStrictEqual(result, [
    ...
    "[v1_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v1_last]",
    "[2:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v2]",
    ...
    "[v3_last_src]reverse,select='eq(n,0)',reverse,tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v3_last]",
    ...
    "[v4_last_src]reverse,select='eq(n,0)',reverse,tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v4_last]",
    "[5:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v5]",
    "[v5]split=2[v5][v5_last_src]",
    "[v5_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v5_last]",
    "[6:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v6]",
    "[v6]split=2[v6][v6_last_src]",
    "[v6_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v6_last]",
    "[7:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v7]",
    "[v7]split=2[v7][v7_last_src]",
    "[v7_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v7_last]",
    "[8:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v8]",
    "[v8]split=2[v8][v8_last_src]",
    "[v8_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v8_last]",
    "[9:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v9]",
    "[v9]split=3[v9][v9_first_src][v9_last_src]",
    "[v9_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v9_first]",
    "[v9_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v9_last]",
    "[10:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v10]",
    "[v10]split=3[v10][v10_first_src][v10_last_src]",
    "[v10_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v10_first]",
    "[v10_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v10_last]",
    "[11:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v11]",
    "[v11]split=3[v11][v11_first_src][v11_last_src]",
    "[v11_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v11_first]",
    "[v11_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v11_last]",
    "[12:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v12]",
    "[v12]split=3[v12][v12_first_src][v12_last_src]",
    "[v12_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v12_first]",
    "[v12_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v12_last]",
    "[13:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v13]",
    "[v13]split=2[v13][v13_last_src]",
    "[v13_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v13_last]",
    "[14:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v14]",
    "[v14]split=2[v14][v14_last_src]",
    "[v14_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v14_last]",
    "[15:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v15]",
    "[v15]split=3[v15][v15_first_src][v15_last_src]",
    "[v15_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v15_first]",
    "[v15_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v15_last]",
    "[16:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v16]",
    "[v16]split=3[v16][v16_first_src][v16_last_src]",
    "[v16_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v16_first]",
    "[v16_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v16_last]",
    "[17:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v17]",
    "[v17]split=3[v17][v17_first_src][v17_last_src]",
    "[v17_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v17_first]",
    "[v17_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v17_last]",
    "[18:v]loop=loop=-1:size=1:start=0,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v18]",
    "[v18]split=3[v18][v18_first_src][v18_last_src]",
    "[v18_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v18_first]",
    "[v18_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v18_last]",
    ...
    "[v19_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v19_first]",
    "[v19_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v19_last]",
    ...
    "[v20_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v20_first]",
    "[v20_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v20_last]",
    ...
    "[v21_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v21_first]",
    "[v21_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v21_last]",
    ...
    "[v22_first_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v22_first]",
    ...
    "[v14_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v14_last_loop]",
    "[v15_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v15_first_loop]",
    "[v14_last_loop][v15_first_loop]xfade=transition=wipeleft:duration=1:offset=0,setpts=PTS-STARTPTS+74.95/TB[v14_last_xfade]",
    "[trans_14_o][v14_last_xfade]overlay=enable='between(t,74.95,75.95)'[trans_15_o]",
    "[v15_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v15_last_loop]",
    "[v16_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v16_first_loop]",
    "[v15_last_loop][v16_first_loop]xfade=transition=wiperight:duration=1:offset=0,setpts=PTS-STARTPTS+79.95/TB[v15_last_xfade]",
    "[trans_15_o][v15_last_xfade]overlay=enable='between(t,79.95,80.95)'[trans_16_o]",
    "[v16_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v16_last_loop]",
    "[v17_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v17_first_loop]",
    "[v16_last_loop][v17_first_loop]xfade=transition=wipeup:duration=1:offset=0,setpts=PTS-STARTPTS+84.95/TB[v16_last_xfade]",
    "[trans_16_o][v16_last_xfade]overlay=enable='between(t,84.95,85.95)'[trans_17_o]",
    "[v17_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v17_last_loop]",
    "[v18_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v18_first_loop]",
    "[v17_last_loop][v18_first_loop]xfade=transition=wipedown:duration=1:offset=0,setpts=PTS-STARTPTS+89.95/TB[v17_last_xfade]",
    "[trans_17_o][v17_last_xfade]overlay=enable='between(t,89.95,90.95)'[trans_18_o]",
    "[v18_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v18_last_loop]",
    "[v19_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v19_first_loop]",
    "[v18_last_loop][v19_first_loop]xfade=transition=wipetl:duration=1:offset=0,setpts=PTS-STARTPTS+94.95/TB[v18_last_xfade]",
    "[trans_18_o][v18_last_xfade]overlay=enable='between(t,94.95,95.95)'[trans_19_o]",
    "[v19_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v19_last_loop]",
    "[v20_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v20_first_loop]",
    "[v19_last_loop][v20_first_loop]xfade=transition=wipetr:duration=1:offset=0,setpts=PTS-STARTPTS+99.95/TB[v19_last_xfade]",
    "[trans_19_o][v19_last_xfade]overlay=enable='between(t,99.95,100.95)'[trans_20_o]",
    "[v20_last]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v20_last_loop]",
    "[v21_first]loop=loop=-1:size=1:start=0,trim=duration=1,setpts=PTS-STARTPTS[v21_first_loop]",
    "[v20_last_loop][v21_first_loop]xfade=transition=wipebl:duration=1:offset=0,setpts=PTS-STARTPTS+104.95/TB[v20_last_xfade]",
    "[trans_20_o][v20_last_xfade]overlay=enable='between(t,104.95,105.95)'[trans_21_o]",
...
test("test createVideo with test_transition3.json", async () => {
  ...
  assert.deepStrictEqual(result, [
    ...
    "[v2_last_src]select='eq(n,0)',tpad=stop_mode=clone:stop_duration=5,fps=30,setpts=PTS-STARTPTS[v2_last]",
    "[3:v]tpad=stop_mode=clone:stop_duration=10,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v3]",
    "[4:v]tpad=stop_mode=clone:stop_duration=10,trim=duration=5,fps=30,setpts=PTS-STARTPTS,scale=w=1280:h=720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=black,setsar=1,format=yuv420p[v4]",
    "[v0][v1][v2][v3][v4]concat=n=5:v=1:a=0[concat_video]",
    "[v1_last]format=yuva420p,setpts=PTS-STARTPTS+9.95/TB[v1_last_f]",
