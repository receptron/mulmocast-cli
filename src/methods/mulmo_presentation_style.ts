...
// Default CSS styles for text slides and markdown rendering.
// height:100% on html/body ensures background fills viewport for screenshot.
// background:white prevents transparent background in rendered images.
const defaultTextSlideStyles = [
  ...
  "body { margin: 60px; margin-top: 40px; color:#333; font-size: 30px; font-family: Arial, sans-serif; box-sizing: border-box; background: white; }",
